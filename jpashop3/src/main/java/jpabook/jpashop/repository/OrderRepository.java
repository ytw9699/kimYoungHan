...
public class OrderRepository {
    ...
    public List<Order> findAllByString(OrderSearch orderSearch) {// 이방법도 중간에 오타날 가능성큼..복잡함
     ...
     * JPA Criteria
     */
    public List<Order> findAllByCriteria(OrderSearch orderSearch) {//이방식은 무슨 쿼리가 생겨날지 안떠오르는 단점..
